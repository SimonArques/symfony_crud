...
use app\CrudBundle\Form\CommandType;
...
class CommandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('appCrudBundle:Command')->findAll();
     ...
     * @Method("POST")
     * @Template("appCrudBundle:Command:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('appCrudBundle:Command')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("appCrudBundle:Command:edit.html.twig")
     */
