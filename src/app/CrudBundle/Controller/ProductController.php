...
use app\CrudBundle\Form\ProductType;
...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('appCrudBundle:Product')->findAll();
     ...
     * @Method("POST")
     * @Template("appCrudBundle:Product:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('appCrudBundle:Product')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("appCrudBundle:Product:edit.html.twig")
     */
